                    ...
                    <div className="relative mx-auto mt-10 w-full max-w-xl">
                        ...
                        {!files.length && (
                            <motion.div
                                ...
                                className={cn(
                                    ...
                                    "shadow-[0px_10px_50px_rgba(0,0,0,0.1)] border border-neutral-200 dark:border-neutral-800",
                                )}
                            >
                                {isDragActive ? (
                                    <motion.p
                        ...
                        {!files.length && (
                            <motion.div
                                ...
                                className="absolute inset-0 z-30 mx-auto mt-4 flex h-32 w-full max-w-[8rem] items-center justify-center rounded-md border border-dashed border-emerald-400 bg-transparent opacity-0"
                            ></motion.div>
                        )}
                    </div>
                </div>
...
export function GridPattern() {
    ...
    const rows = 11;
    return (
        <div className="flex shrink-0 scale-105 flex-wrap items-center justify-center gap-x-px gap-y-px bg-gray-100 dark:bg-neutral-900 pointer-events-none">
